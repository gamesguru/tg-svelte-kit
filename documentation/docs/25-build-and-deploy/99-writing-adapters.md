...
export default function (options) {
	/** @type {import('@tg-svelte/kit').Adapter} */
	const adapter = {
...
- Output code that:
	...
	- Globally shims `fetch` to work on the target platform, if necessary. SvelteKit provides a `@tg-svelte/kit/node/polyfills` helper for platforms that can use `undici`
