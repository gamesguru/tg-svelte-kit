...
A SvelteKit project is really just a [Vite](https://vitejs.dev) project that uses the [`@tg-svelte/kit/vite`](@sveltejs-kit-vite) plugin, along with any other [Vite configuration](https://vitejs.dev/config/).
